...
const publicWatch=(watch:GrantWatch)=>{const{lastSeenGrantState:_internalBaseline,ownerKey:_owner,email,...value}=watch;return{...value,email:maskWatchEmail(email)}};
